...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/Adibotkaiaia/ADI_Music/blob/master/config.py", # dont Change this otherwise u get error 🧧
)
...
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/II_VIP_FUCKER_II")
